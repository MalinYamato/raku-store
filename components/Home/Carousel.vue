    ...
    <div id="heroControls" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="img-fluid" src="~/assets/rakuheadphones.jpg" alt="First-slide" title="First-slide">
        </div>
        <div class="carousel-item">
          <img class="img-fluid" src="~/assets/skylt.png" alt="Second-slide" title="Second-slide">
        </div>
        <div class="carousel-item">
          <img class="img-fluid" src="~/assets/skylt.jpg" alt="Third-slide" title="Third-slide">
        </div>
      </div>
    </div>
  </section>
