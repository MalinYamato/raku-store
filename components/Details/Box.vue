    ...
    <div class="row mb-5">
      ...
      <div class="col6 col-xl-6 col-lg-6 col-md-12 col-sm-12 d-flex align-items-center justify-content-start">
        <div class="info pt-xl-0 pt-lg-0 pt-5">
          ...
          <h1 class="font-semibold  text-uppercase pt-3 text-xl">{{ item.title }}</h1>
         <h4>Price: EUR {{ item.price }}</h4>
         <h4>Impedance: {{ item.impedance }} Ohm</h4>
         <h4>Sensitivty: {{ item.sensitivity }}</h4> <br>
         <p text-lg>{{ item.description }}</p>
          <br><br><br>
